...
public class HighgoTablePath {
    ...
    public HighgoTablePath(String pgSchemaName, String pgTableName) {
    ...
    public static HighgoTablePath fromFlinkTableName(String flinkTableName) {
        if (flinkTableName.contains(".")) {
            ...
            return new HighgoTablePath(path[0], path[1]);
        } else {
            return new HighgoTablePath(DEFAULT_POSTGRES_SCHEMA_NAME, flinkTableName);
        }
    }

    public static String toFlinkTableName(String schema, String table) {
        return new HighgoTablePath(schema, table).getFullPath();
    }
    ...
    public boolean equals(Object o) {
        ...
        HighgoTablePath that = (HighgoTablePath) o;
