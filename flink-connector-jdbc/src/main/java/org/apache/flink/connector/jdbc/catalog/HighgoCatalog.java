...
import org.apache.flink.connector.jdbc.dialect.highgo.HighgoTypeMapper;
...
/** Catalog for Highgo. */
@Internal
public class HighgoCatalog extends AbstractJdbcCatalog {

    private static final Logger LOG = LoggerFactory.getLogger(HighgoCatalog.class);

    public static final String DEFAULT_DATABASE = "highgo";
    ...
    protected HighgoCatalog(
        ...
        this.dialectTypeMapper = new HighgoTypeMapper();
    }
    ...
    protected String getTableName(ObjectPath tablePath) {
        return HighgoTablePath.fromFlinkTableName(tablePath.getObjectName()).getPgTableName();
    }

    @Override
    protected String getSchemaName(ObjectPath tablePath) {
        return HighgoTablePath.fromFlinkTableName(tablePath.getObjectName()).getPgSchemaName();
    }

    @Override
    protected String getSchemaTableName(ObjectPath tablePath) {
        return HighgoTablePath.fromFlinkTableName(tablePath.getObjectName()).getFullPath();
    }
}
