...
/** HighgoTypeMapper util class. */
@Internal
public class HighgoTypeMapper implements JdbcDialectTypeMapper {

    private static final Logger LOG = LoggerFactory.getLogger(HighgoTypeMapper.class);
